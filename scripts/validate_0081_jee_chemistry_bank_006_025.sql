-- READ ONLY: validate 0081 JEE Chemistry bank expansion
...
-- Expected: 26 rows, 25 active questions per row.
...
-- Expected new-bank rows for this subject: 520.

SELECT question_key,COUNT(*) AS copies
FROM education_questions
WHERE question_key LIKE 'IN_PROGRAM_JEE_CHEMISTRY_%'
