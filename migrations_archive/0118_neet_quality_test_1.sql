...
--
-- Quality strategy:
--   * Reuse all 70 reviewed NEET_2026 starter questions.
...
-- 122. BIOLOGY existing reviewed | easy | CELL_STRUCTURE_FUNCTION
INSERT INTO education_mock_test_questions
(mock_test_id,question_id,question_order,section_code,
 marks_correct,marks_incorrect,marks_unanswered)
SELECT
...
-- 124. BIOLOGY existing reviewed | easy | CELL_STRUCTURE_FUNCTION
INSERT INTO education_mock_test_questions
(mock_test_id,question_id,question_order,section_code,
 marks_correct,marks_incorrect,marks_unanswered)
SELECT
...
-- 126. BIOLOGY existing reviewed | medium | CELL_STRUCTURE_FUNCTION
INSERT INTO education_mock_test_questions
(mock_test_id,question_id,question_order,section_code,
 marks_correct,marks_incorrect,marks_unanswered)
SELECT
...
-- 128. BIOLOGY existing reviewed | medium | CELL_STRUCTURE_FUNCTION
INSERT INTO education_mock_test_questions
(mock_test_id,question_id,question_order,section_code,
 marks_correct,marks_incorrect,marks_unanswered)
SELECT
...
-- 130. BIOLOGY existing reviewed | medium | CELL_STRUCTURE_FUNCTION
INSERT INTO education_mock_test_questions
(mock_test_id,question_id,question_order,section_code,
 marks_correct,marks_incorrect,marks_unanswered)
SELECT
